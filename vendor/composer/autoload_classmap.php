...
return array(
    ...
    'IPub\\SlimRouter\\Controllers\\ControllerResolver' => $vendorDir . '/ipub/slim-router/src/Controllers/ControllerResolver.php',
    'IPub\\SlimRouter\\Controllers\\IControllerResolver' => $vendorDir . '/ipub/slim-router/src/Controllers/IControllerResolver.php',
    'IPub\\SlimRouter\\Exceptions\\HttpException' => $vendorDir . '/ipub/slim-router/src/Exceptions/HttpException.php',
    'IPub\\SlimRouter\\Exceptions\\HttpMethodNotAllowedException' => $vendorDir . '/ipub/slim-router/src/Exceptions/HttpMethodNotAllowedException.php',
    'IPub\\SlimRouter\\Exceptions\\HttpNotFoundException' => $vendorDir . '/ipub/slim-router/src/Exceptions/HttpNotFoundException.php',
    'IPub\\SlimRouter\\Exceptions\\HttpSpecializedException' => $vendorDir . '/ipub/slim-router/src/Exceptions/HttpSpecializedException.php',
    'IPub\\SlimRouter\\Exceptions\\IException' => $vendorDir . '/ipub/slim-router/src/Exceptions/IException.php',
    'IPub\\SlimRouter\\Exceptions\\InvalidArgumentException' => $vendorDir . '/ipub/slim-router/src/Exceptions/InvalidArgumentException.php',
    'IPub\\SlimRouter\\Exceptions\\RuntimeException' => $vendorDir . '/ipub/slim-router/src/Exceptions/RuntimeException.php',
    'IPub\\SlimRouter\\Exceptions\\StreamResourceCallException' => $vendorDir . '/ipub/slim-router/src/Exceptions/StreamResourceCallException.php',
    'IPub\\SlimRouter\\Http\\Response' => $vendorDir . '/ipub/slim-router/src/Http/Response.php',
    'IPub\\SlimRouter\\Http\\ResponseFactory' => $vendorDir . '/ipub/slim-router/src/Http/ResponseFactory.php',
    'IPub\\SlimRouter\\Http\\Stream' => $vendorDir . '/ipub/slim-router/src/Http/Stream.php',
    'IPub\\SlimRouter\\Middleware\\IMiddlewareDispatcher' => $vendorDir . '/ipub/slim-router/src/Middleware/IMiddlewareDispatcher.php',
    'IPub\\SlimRouter\\Middleware\\MiddlewareDispatcher' => $vendorDir . '/ipub/slim-router/src/Middleware/MiddlewareDispatcher.php',
    'IPub\\SlimRouter\\Routing\\FastRouteDispatcher' => $vendorDir . '/ipub/slim-router/src/Routing/FastRouteDispatcher.php',
    'IPub\\SlimRouter\\Routing\\Handlers\\IHandler' => $vendorDir . '/ipub/slim-router/src/Routing/Handlers/IHandler.php',
    'IPub\\SlimRouter\\Routing\\Handlers\\IRequestHandler' => $vendorDir . '/ipub/slim-router/src/Routing/Handlers/IRequestHandler.php',
    'IPub\\SlimRouter\\Routing\\Handlers\\RequestHandler' => $vendorDir . '/ipub/slim-router/src/Routing/Handlers/RequestHandler.php',
    'IPub\\SlimRouter\\Routing\\Handlers\\RequestResponseArgsHandler' => $vendorDir . '/ipub/slim-router/src/Routing/Handlers/RequestResponseArgsHandler.php',
    'IPub\\SlimRouter\\Routing\\Handlers\\RequestResponseHandler' => $vendorDir . '/ipub/slim-router/src/Routing/Handlers/RequestResponseHandler.php',
    'IPub\\SlimRouter\\Routing\\IRoute' => $vendorDir . '/ipub/slim-router/src/Routing/IRoute.php',
    'IPub\\SlimRouter\\Routing\\IRouteCollector' => $vendorDir . '/ipub/slim-router/src/Routing/IRouteCollector.php',
    'IPub\\SlimRouter\\Routing\\IRouteGroup' => $vendorDir . '/ipub/slim-router/src/Routing/IRouteGroup.php',
    'IPub\\SlimRouter\\Routing\\IRouteParser' => $vendorDir . '/ipub/slim-router/src/Routing/IRouteParser.php',
    'IPub\\SlimRouter\\Routing\\IRouter' => $vendorDir . '/ipub/slim-router/src/Routing/IRouter.php',
    'IPub\\SlimRouter\\Routing\\Route' => $vendorDir . '/ipub/slim-router/src/Routing/Route.php',
    'IPub\\SlimRouter\\Routing\\RouteCollector' => $vendorDir . '/ipub/slim-router/src/Routing/RouteCollector.php',
    'IPub\\SlimRouter\\Routing\\RouteGroup' => $vendorDir . '/ipub/slim-router/src/Routing/RouteGroup.php',
    'IPub\\SlimRouter\\Routing\\RouteHandler' => $vendorDir . '/ipub/slim-router/src/Routing/RouteHandler.php',
    'IPub\\SlimRouter\\Routing\\RouteParser' => $vendorDir . '/ipub/slim-router/src/Routing/RouteParser.php',
    'IPub\\SlimRouter\\Routing\\Router' => $vendorDir . '/ipub/slim-router/src/Routing/Router.php',
    'IPub\\SlimRouter\\Routing\\RoutingResults' => $vendorDir . '/ipub/slim-router/src/Routing/RoutingResults.php',
    ...
    'Source\\Http\\Controller\\Controller' => $baseDir . '/source/Http/Controller/Controller.php',
    'Source\\Http\\Controller\\Site\\Site' => $baseDir . '/source/Http/Controller/Site/Site.php',
