...
<body centralize>
    <div class="recover_password_card">
        ...
        <div class="card_body" centralize>
            ...
            <form action="<?php echo e($router->route('auth.recoverPassword')); ?>" method="post">
                
                <?php if($error = flashGet('error', 'recover_password')): ?>
                    <div class="message highlight-error">
                        <?php echo e($error); ?>

                    </div>
                <?php endif; ?>
                <?php if($success = flashGet('success', 'recover_password')): ?>
...
</html><?php /**PATH /var/www/html/note/source/view/site/recoverPassword.blade.php ENDPATH**/ ?>